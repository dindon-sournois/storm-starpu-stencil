#+INCLUDE: "~/rev/internship/storm/rapport/header.org"
...
** Ordonnancement de tâches pour applications stencils
    ...
    - pour discrétiser des phénomènes physiques locaux sur des grilles régulières
...
#+NAME: fig:3D_stencil
#+CAPTION: Stencil 6-points 3D - La mise à jour d'un élément se fait à partir des 6 éléments voisins cite:6points-stencil.
