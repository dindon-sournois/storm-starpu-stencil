...
** Le domaine du calcul haute performance
   ...
   dépend de l'arbre de tâches construit. Un exemple de graphe de dépendances de
...
\hspace*{\fill}
\subfloat[Exécution avec deux GPUs.]
  {\includegraphics[width=0.2\linewidth]{img/example-iter.png}}
\hspace*{\fill}
\subfloat[Légende.]
