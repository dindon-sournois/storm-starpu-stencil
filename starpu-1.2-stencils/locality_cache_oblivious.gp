...
plot \
     ...
     using ($1):($2)/($1)\
     with linespoints title "cache-oublieux 2 GPU" ls 5 lw 2 pt 1, \
     "./output/perf_2_dmdar_200_1.txt" \
     using ($1):($2)/($1) \
     with linespoints title "dmdar 2 GPU" ls 2 lw 2 pt 2, \
...
plot \
     ...
     using ($1):($2)/($1)\
     with linespoints title "cache-oublieux rep. dynamique" ls 2 lw 2 pt 3, \
...
set output 'load_gpu2_limit200.pdf'

plot \
     "./output/load_2_dmdar_200_dyn-unbalanced-load.txt" \
     using ($1):($2)/($1)\
     with linespoints title "dmdar rep. dynamique" ls 4 lw 2 pt 3, \
     "./output/load_2_co_200_dyn-unbalanced-load.txt" \
     using ($1):($2)/($1)\
     with linespoints title "cache-oublieux rep. dynamique" ls 2 lw 2 pt 3, \
