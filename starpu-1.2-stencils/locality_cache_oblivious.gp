...
set output 'cache_oblivious_gpu1_limit500.pdf'
set title "Limited memory 500 MB"

plot \
     "./output/cache_oblivious_1_500.txt" \
     using ($1):($2)/($1) \
     with linespoints title "cache-oblivious 1 GPU" ls 1 lw 2 pt 1, \
     "./output/cache_oblivious_1_dmdar_500_1.txt" \
     using ($1):($2)/($1) \
